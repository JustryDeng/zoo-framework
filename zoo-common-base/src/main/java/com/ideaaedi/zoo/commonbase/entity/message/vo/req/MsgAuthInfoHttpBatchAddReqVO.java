...
public class MsgAuthInfoHttpBatchAddReqVO extends BaseDTO {
    ...
    /**
    * @see MsgAuthInfoHttpAddReqVO
    */
    @Data
    @EqualsAndHashCode(callSuper = true)
    public static class AddItemParamDTO extends MsgAuthInfoHttpAddReqVO {
