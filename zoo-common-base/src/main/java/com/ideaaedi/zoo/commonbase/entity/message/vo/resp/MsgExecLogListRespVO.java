 ...
 */
@Data
@Schema(description = "消息-执行日志表 list resp")
public class MsgExecLogListRespVO {
    ...
    @ExcelProperty("执行是否成功（仅代表执行这个动作是否成功；0-未知；1-成功；2-失败）")
