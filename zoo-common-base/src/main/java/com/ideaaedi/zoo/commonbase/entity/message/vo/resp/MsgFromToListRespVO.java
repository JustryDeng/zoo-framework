 ...
 */
@Data
@Schema(description = "消息-交互方表 list resp")
public class MsgFromToListRespVO {
    ...
    @ExcelProperty("交互状态（-1-已失效；0-待发送；1-已发送，发送成功；2-已发送，发送失败；3-已发送，结果未知）")
