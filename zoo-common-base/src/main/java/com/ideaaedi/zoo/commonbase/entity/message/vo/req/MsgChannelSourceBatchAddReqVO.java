...
public class MsgChannelSourceBatchAddReqVO extends BaseDTO {
    ...
    /**
    * @see MsgChannelSourceAddReqVO
    */
    @Data
    @EqualsAndHashCode(callSuper = true)
    public static class AddItemParamDTO extends MsgChannelSourceAddReqVO {
