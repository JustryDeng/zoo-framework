 ...
 */
@Data
@Schema(description = "系统-菜单表 list resp")
public class SysMenuListRespVO {
    ...
    @ExcelProperty("菜单路径（从最顶级菜单到当前菜单的路径）")
    private String path;
    ...
    @ExcelProperty("同一级菜单的排序优先级（越小越靠前）")
