 ...
 */
@Data
@Schema(description = "消息-模板表 list resp")
public class MsgTemplateListRespVO {
    ...
    @ExcelProperty("需要的参数信息数组（数组中的json对象包含这些字段：name-参数名；type-参数类型；desc-参数说明；required-是否必须）")
    ...
    @ExcelProperty("模板状态（-1-草稿态；1-可用；2-禁用）")
