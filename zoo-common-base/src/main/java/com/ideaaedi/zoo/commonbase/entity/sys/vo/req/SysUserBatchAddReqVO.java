...
@Schema(description = "系统-用户表 batch add resp")
public class SysUserBatchAddReqVO extends BaseDTO {
    ...
    /**
    * @see com.ideaaedi.zoo.commonbase.entity.sys.req.SysUserAddReqVO
    */
    @Data
    @EqualsAndHashCode(callSuper = true)
    public static class AddItemParamDTO extends SysUserAddReqVO {
