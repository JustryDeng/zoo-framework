...
import com.ideaaedi.zoo.commonbase.entity.message.vo.req.MsgChannelSinkBatchAddReqVO;
...
public class MsgChannelSinkBatchAddRespVO {
    ...
    private List<MsgChannelSinkBatchAddReqVO.AddItemParamDTO> dataList;
}